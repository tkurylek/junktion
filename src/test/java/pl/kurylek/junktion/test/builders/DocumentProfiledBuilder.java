...
public class DocumentProfiledBuilder extends Builder<DocumentBuilder> {
	...
	return aDocument().withId(STRING_THEORY_ID).withAuthor(STRING_THEORY_AUTHOR).withFilename(STRING_THEORY_ID)
		.withPath(STRING_THEORY_LOCATION).withSize(STRING_THEORY_SIZE).withContent(STRING_THEORY_CONTENT);
    }
}
